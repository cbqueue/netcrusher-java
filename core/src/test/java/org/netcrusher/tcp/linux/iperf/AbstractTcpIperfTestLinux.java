...
public class AbstractTcpIperfTestLinux extends AbstractTestLinux {

    private static final Logger LOGGER = LoggerFactory.getLogger(AbstractTcpIperfTestLinux.class);
